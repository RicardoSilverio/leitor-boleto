...
public final class BoletoComercial implements Boleto {
	...
	private static final String DV_BARRAS_INVALIDO = "0";
	private static final String CONSTANTE_BOLETO_CONCESSIONARIA = "8";
	
	protected boolean valido;
	
	protected RepresentacaoNumerica linhaDigitavel;
	protected RepresentacaoNumerica codigoBarras;
	...
	public BoletoComercial(RepresentacaoNumerica representacaoNumerica) {
		...
		if(representacaoNumerica.getRepresentacaoNumerica().startsWith(CONSTANTE_BOLETO_CONCESSIONARIA)) {
			valido = false;
			return;
		}
	...
	private boolean processarLinhaDigitavel() {
		...
		if(dvCodigoBarras.equals(DV_BARRAS_INVALIDO)) {
			return false;
		}
